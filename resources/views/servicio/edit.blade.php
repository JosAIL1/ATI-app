        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
                ...
                <form action="/servicios/{{$servicio->id}}" method="POST">
                    ...
                    <p>
                        <label>Nombre</label>
                        <input id="nombre" type="text" name="nombre" class="form-control" tabindex="1" Value="{{$servicio->nombre}}">
                    </p>
                    <p>
                        <label>Apellido</label>
                        <input id="apellido" type="text" name="apellido" class="form-control" tabindex="2" Value="{{$servicio->apellido}}">
                    </p>
                    <p>
                        <label>Correo Electronico</label>
                        <input id="correo" type="email" name="correo" class="form-control" tabindex="3" value="{{$servicio->correo}}">
                    </p>
                    <p>
                        <label>Dependencia/Institucion</label>
                        <input id="dependencia" type="text" name="dependencia" class="form-control" tabindex="4" value="{{$servicio->dependencia}}">
                    </p>
                    <p>
                        <label>Area</label>
                        <input id="area" type="text" name="area" class="form-control" tabindex="5" value="{{$servicio->area}}">
                    </p>
                    <p>
                        <label>Domicilio</label>
                        <input id="domicilio" type="text" name="domicilio" class="form-control" tabindex="6" value="{{$servicio->domicilio}}">
                    </p>
                    <p>
                        <label>Numero de télefono</label>
                        <input id="telefono" type="telefono" name="telefono" class="form-control" tabindex="7" value="{{$servicio->telefono}}">
                    </p> 
                    <p>
                        <label>Fecha</label>
                        <input id="fecha" type="date" name="fecha" class="form-control" tabindex="8" value="{{$servicio->fecha}}">
                    </p>
                    <p>
                        <label>Marca/Equipo</label>
                        <input id="marca" type="text" name="marca" class="form-control" tabindex="9" value="{{$servicio->marca}}">
                    </p>  
                    <p>
                        <label>Numero/serie</label>
                        <input id="serie" type="text" name="serie" class="form-control" tabindex="10" value="{{$servicio->serie}}">
                    </p>   
                    <p>
                        <label>Factura</label>
                        <input id="factura" type="text" name="factura" class="form-control" tabindex="11" value="{{$servicio->factura}}">
                    </p>          
                    <p>
                    ...
                    <p>
                       <label>Status</label> 
                        <input id="status" name="status" class="form-control" tabindex="12" value="{{$servicio->status}}">
                    </p>
                    <p class="block">
